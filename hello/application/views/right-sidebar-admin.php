...
<aside id="leftsidebar" class="sidebar"> 
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li > <a href="javascript:void(0);" class="menu-toggle"> <i class="material-icons">account_balance</i> <span class="icon-name">CoE</span> </a>
                <ul class="ml-menu">

                    <li><a href="">CoE</a></li>
                    <li><a href="">Assign Lecturer</a></li>
                    <li ><a href="<?php echo base_url(); ?>/news/news_CoE/new_s"> News </a></li>
            ...
            <li > <a href="javascript:void(0);" class="menu-toggle"> <i class="material-icons">account_balance</i> <span class="icon-name">FIS</span> </a>
                <ul class="ml-menu">
                    
                    <li><a href="">FIS</a></li>
                    <li><a href="">Assign Lecturer</a></li>
                    <li ><a href="<?php echo base_url(); ?>/news/news_FIS/new_s"> News </a></li>
                    <li><a href="">Organization</a></li>
                    <li><a href="">Time Setting</a></li>
                    <li><a href="">Export Summarize</a></li>
                    <li><a href="">Import</a></li>
            ...
            <li > <a href="javascript:void(0);" class="menu-toggle"> <i class="material-icons">account_balance</i> <span class="icon-name">FTE Cooperative</span> </a>
                <ul class="ml-menu">

                    <li><a href="">FTE Cooperative</a></li>
                    <li><a href="">Assign Lecturer</a></li>
                    <li ><a href="<?php echo base_url(); ?>/news/news_FTECo/new_s"> News </a></li>
                    <li><a href="">Organization</a></li>
                    <li><a href="">Time Setting</a></li>
                    <li><a href="">Export Summarize</a></li>
                    <li><a href="">Import</a></li>
            ...
            <li > <a href="javascript:void(0);" class="menu-toggle"> <i class="material-icons">account_balance</i> <span class="icon-name">FTE Internship</span> </a>
                <ul class="ml-menu">
                    
                
                    <li><a href="">FTE Internship</a></li>
                    <li><a href="">Assign Lecturer</a></li>
                    <li ><a href="<?php echo base_url(); ?>/news/news_FTEIn/new_s"> News </a></li>
                    <li><a href="">Organization</a></li>
                    <li><a href="">Time Setting</a></li>
                    <li><a href="">Export Summarize</a></li>
                    <li><a href="">Import</a></li>
            ...
            <li ><a href="<?php echo base_url(); ?>TipsTricks/TipsTricks/Tips_Tricks"><i class="material-icons">highlight</i> <span class="icon-name">Add Faculty</span> </a></li>
