...
$.AdminX.leftSideBar = {
    ...
    setMenuHeight: function () {
        if (typeof $.fn.slimScroll != 'undefined') {
            var configs = $.AdminX.options.leftSideBar;
...
$.AdminX.dropdownMenu = {
    ...
    dropdownEffect: function (target) {
        var effectIn = $.AdminX.options.dropdownMenu.effectIn, effectOut = $.AdminX.options.dropdownMenu.effectOut;
...
$(function () {
    $.AdminX.browser.activate();
    $.AdminX.leftSideBar.activate();
    $.AdminX.rightSideBar.activate();
    $.AdminX.navbar.activate();
    $.AdminX.dropdownMenu.activate();
    $.AdminX.input.activate();
    $.AdminX.select.activate();
    $.AdminX.search.activate();
