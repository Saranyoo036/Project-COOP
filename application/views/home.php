                                ...
                                <select class="form-control" id="major" disabled onchange="document.getElementById('selectbtn').disabled = ''">
                                    <option value="">Please select major</option>
										...
										<div class="" id="menuwrapper" style="display:none">
											...
											<a id="stdbtn" class="btn btn-raised g-bg-purple waves-effect m-b-15 collapsed" onclick="goto(document.getElementById('major').value,document.getElementById('selection').value,this.id)">student</a>
											<a id="assignbtn" class="btn btn-raised g-bg-purple waves-effect m-b-15 collapsed" onclick="goto(document.getElementById('major').value,document.getElementById('selection').value,this.id)">Assign lacturer</a>
											<a id="newsbtn" class="btn btn-raised g-bg-purple waves-effect m-b-15 collapsed" onclick="goto(document.getElementById('major').value,document.getElementById('selection').value,this.id)">news</a>
											<a id="orgbtn" class="btn btn-raised g-bg-purple waves-effect m-b-15 collapsed" onclick="goto(document.getElementById('major').value,document.getElementById('selection').value,this.id)">Organization</a>
											<a id="timebtn" class="btn btn-raised g-bg-purple waves-effect m-b-15 collapsed" onclick="goto(document.getElementById('major').value,document.getElementById('selection').value,this.id)">time Setting</a>
											<a id="exportbtn" class="btn btn-raised g-bg-purple waves-effect m-b-15 collapsed" onclick="goto(document.getElementById('major').value,document.getElementById('selection').value,this.id)">export Summarize</a>
											<a id="importbtn" class="btn btn-raised g-bg-purple waves-effect m-b-15 collapsed" onclick="goto(document.getElementById('major').value,document.getElementById('selection').value,this.id)">import</a>
									</div>
