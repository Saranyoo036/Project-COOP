                                    ...
                                    <div class="row clearfix">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="name_and_surname_thai_1" placeholder="ชื่อ-นามสกุล ไทย (Name &amp; Surname Thai)">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="" placeholder="รหัสนักศึกษา (Std.ID.)" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" name="advisor_name_1" placeholder="ชื่ออาจารย์ที่ปรึกษา ไทย (Name of academic advisor Thai)" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
