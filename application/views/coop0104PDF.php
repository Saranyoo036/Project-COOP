...
$position_1 = $coop0202_1->job_position;
$oraganization_name_1 = $coop0202_1->organization_name;
$oraganization_province_1 = $coop0202_1->province;
$subject_id_name_1 = $related_1->course;
$study_semester_1 = $related_1->semester;
$gpa_1 = $related_1->grade;
$certificate_1 = $related_1->cert;
$training_time_1 = $related_1->duration;
$start_date_1 = $related_1->start;
$end_date_1 = $related_1->end;

$position_2 = $coop0202_2->job_position;
$oraganization_name_2 = $coop0202_2->organization_name;
$oraganization_province_2 = $coop0202_2->province;
if($related_2) {
...
$pdf::Cell(80, 8, iconv('UTF-8', 'cp874', 'ชื่สถานประกอบการ'), 'LTB', 0, 'C');
