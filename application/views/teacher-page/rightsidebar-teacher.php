...
<aside id="leftsidebar" class="sidebar"> 
    ...
    <div class="menu">
        <ul class="list">
            ...
            <li class="active open"><a href="<?php echo base_url(); ?>Welcome_teacher/index"><i class="zmdi zmdi-home"></i><span>Home</span> </a></li>


            <li ><a href="<?php echo base_url(); ?>TeacherPage/Allstatuspage/Allstatus_page"><i class="material-icons">contact_phone</i> <span class="icon-name">All Status</span> </a></li>
