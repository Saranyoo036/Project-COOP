...
<section class="content home">
	<div class="container-fluid">
	 ...
	 <div class="card">
                        ...
                        <div class="header">
                            <h2>คำร้องขอจากนักศึกษาฝึกงาน (Requests from students Internship)</h2>
                            ...
                            <div class="body">
                                <div class="table-responsive">
										<table class="table">
	                                        ...
	                                        $sql = "SELECT * FROM `major_setting_personnel` WHERE major_type = 'internship' AND `personnel_id` = $TID";
